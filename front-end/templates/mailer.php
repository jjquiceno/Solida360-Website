...
<html lang="en">
<head>
    <meta name="description" content="Contáctanos en Sólida 360 para todas tus necesidades de marketing, diseño, impresos, fotografía y sitios web. Nuestro equipo en Envigado - Colombia está listo para ayudarte a impulsar tu marca. ¡Hablemos!">
    <meta name="robots" content="index, follow">
    <meta name="author" content="Sólida">
    <meta charset="UTF-8">
            ...
            <div class="form">
                <form method="POST" class="form_form">
                    ...
                    <div class="info-message" data-validate="El asunto es necesario">  
                        <input class="caja_text" type="text" name="asunto" required>
                        <label class="label" for="asunto">ASUNTO</label>
                        <span></span>
                    </div>
                    <div class="info-message" data-validate="Escriba el mensaje por favor">
                        <textarea name="mensaje" id="" cols="30" rows="10" class="caja_text" required></textarea>
    ...
    if ($mail) {
        echo "
            <script>
                ...
                window.location.href = 'impresos.html'
            </script>";
    } else {
        echo "
            <script>
