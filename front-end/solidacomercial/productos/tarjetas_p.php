...
<body>
    ...
    <section class="productDetail">
        ...
        <div class="costos">
            <div>
                <h1 class="tittles">Tarjetas de Presentacion</h1>
                <p id="valorproducto">313000</p>
            </div>
            <form method="post">
                <div class="perso">
                    <div>
            ...
            <div>
                ...
                <p id="costouni">313000</p>
                <br>
                <hr>
                <br>
                <h2>Total: </h2>
                <div id="totaladd">
                    <p id="totalValue">313000</p>
                    <button id="addtocartbutton" onclick="agregarAlCarrito('Remito', document.querySelector('.tamañoRemito').value, document.querySelector('.tipoRemito').value, document.querySelector('.tipoCopias').value, document.querySelector('.tipoEncuadernado').value, document.getElementById('cajacantidad').value)">¡AGREGAR!</button>
                    <script>
            ...
            <script>
                ...
                function agregarAlCarrito(producto, tamañoR, tipoR, tipoC, tipoE, cantidad) {
                    ...
                    const itemPrecio = valorUnidad * cantidad;  // Aquí asumes un precio fijo de 10
                     

                    // Utilizar la estructura solicitada para mostrar la información
                    item.innerHTML = `
                        <ul class="listCaract">
                            <li><b>${producto}</b></li>
