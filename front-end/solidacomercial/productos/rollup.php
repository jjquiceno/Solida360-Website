        ...
        <div class="costos">
            ...
            <div>
                ...
                <div id="totaladd">
                    ...
                    <button id="addtocartbutton" onclick="agregarAlCarrito('Roll up', document.querySelector('.tamañoRemito').value, document.querySelector('.tipoRemito').value, document.querySelector('.tipoCopias').value, document.querySelector('.tipoEncuadernado').value, document.getElementById('cajacantidad').value)">¡AGREGAR!</button>
                    <script>
